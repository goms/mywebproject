...
<%@page import="com.chitfund.GroupHead.GroupHeadDao"%>
...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <%	
 		...
 		GroupHeadDao ghd=new GroupHeadDao();
		int gid=pp.getGid();
		int pid=pp.getPid();
		int type=pp.getType();
		...
		String fAcc=accNo;
		if(ddAcc.isSelMember(pp.getGid()))
		{
			pSM=ghd.updateSelMember(pp);
			
		}
		else
		{
			pSM=ghd.getSelectedMember(pp);
			
				
		}
		tAcc=ddAcc.getAccountNumberPID(pSM.getPid());
 ...
 <div class="row2">
 	<ul class="nav nav-pills">
 		...
 		<li class="nav-item">
 			<a class=nav-link href="#members" data-toggle="collapse">Members</a>
 		</li>
 		<li class="nav-item">
 		...
 		<li class="nav-item">
 			<a class=nav-link href="#setRate" data-toggle="collapse">Rate</a>
 		</li>
 	</ul>
 </div>
 <div class="rows">
 ...
 <div class="col-lg-8">
 	...
 	<div id="members" class="collapse">
 		<table class="table table-hover">
 			...
 			<tbody>
 				<%
 					ArrayList<PersonBean> personAL=ghd.getMembers(pp);
 					Iterator<PersonBean> it=personAL.iterator();%>
 					<% while(it.hasNext())
 					{%>
 					...
 					<%}%>
 					<tr>
 						<td> <b>Selected Member</b> </td>
 						<td><%=pSM.getPid() %></td>
 						<td><%=pSM.getUsername() %></td>
 					</tr>
 			</tbody>
	...
	<div class="collapse" id="transferMoney">
			<div class="row">
				<form action="UTransferMoney" method="post" onsubmit="return sendSucccess()">
					<div class="col-lg-4">
					</div>
					<div class="col-lg-4" align="center">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<% 	session.setAttribute("fAcc",accNo);
									session.setAttribute("tAcc",tAcc ); %>
							</div>
						</div>
						<div id="form-group">
 ...
 <div class="row">
 	<div class="alert alert-success fade-in collapse" id="sendingmoney" style="display:none">
